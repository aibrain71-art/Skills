...
| [`defuddle`](./defuddle) | Extrahiert sauberes Markdown aus Webseiten über die Defuddle-CLI — Alternative zu WebFetch, wirft Navigation und Werbung raus und spart Tokens. | [kepano/obsidian-skills](https://github.com/kepano/obsidian-skills) |
...
| [`json-canvas`](./json-canvas) | Erstellt und bearbeitet JSON-Canvas-Dateien (`.canvas`): Nodes, Kanten, Gruppen — für Mindmaps und Flowcharts in Obsidian. | [kepano/obsidian-skills](https://github.com/kepano/obsidian-skills) |
...
| [`obsidian-bases`](./obsidian-bases) | Baut Obsidian Bases (`.base`): datenbankartige Views auf Notizen mit Filtern, Formeln und Summaries. | [kepano/obsidian-skills](https://github.com/kepano/obsidian-skills) |
| [`obsidian-cli`](./obsidian-cli) | Steuert einen laufenden Obsidian-Vault über die `obsidian`-CLI: Notizen, Suche, Tasks, Properties — plus Debugging von Plugins und Themes. | [kepano/obsidian-skills](https://github.com/kepano/obsidian-skills) |
| [`obsidian-markdown`](./obsidian-markdown) | Schreibt Obsidian Flavored Markdown: Wikilinks, Embeds, Callouts, Properties und weitere Obsidian-Syntax. | [kepano/obsidian-skills](https://github.com/kepano/obsidian-skills) |
